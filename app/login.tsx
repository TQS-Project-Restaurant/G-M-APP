...
export default function LoginScreen() {
    ...
    const [passord,setPassowrd] = useState("");
  ...
  return (
    <View className='bg-white h-[105%] flex flex-col items-center justify-center gap-5'>
        ...
        <TextInput className=' border border-black rounded-md w-[60%] p-2' placeholder='password' onChange={(e)=>setPassowrd(e.nativeEvent.text)}></TextInput>
        <View className='w-[40%]'>
